...
- (void)viewDidLoad {
    ...
    self.viewBar = [[UIView alloc] initWithFrame:CGRectMake(-1, 0, screenWidth+1, 50)];
...
- (UIView*)createMessageWithText: (NSString*)text Image: (UIImage*)image DateTime: (NSString*)dateTimeString isReceived: (BOOL)isReceived
{
    ...
    chatBubbleView.backgroundColor = [UIColor colorWithRed:0.94 green:0.49 blue:0.4 alpha:1];
    chatTimeLabel.backgroundColor = [UIColor colorWithRed:0.94 green:0.49 blue:0.4 alpha:1];
    chatBubbleLabel.backgroundColor = [UIColor colorWithRed:0.94 green:0.49 blue:0.4 alpha:1];
    chatBubbleContentView.backgroundColor = [UIColor colorWithRed:0.94 green:0.49 blue:0.4 alpha:1];
    ...
    [arrowIV setTintColor:[UIColor colorWithRed:0.94 green:0.49 blue:0.4 alpha:1]];
    ...
    if (isReceived == 0)
    {
        ...
        chatBubbleView.frame = CGRectMake(screenWidth-(chatBubbleContentView.frame.size.width+10)-10, 10, chatBubbleContentView.frame.size.width+10, chatBubbleContentView.frame.size.height+10);
         ...
         chatBubbleView.backgroundColor = [UIColor colorWithRed:0.9 green:0.9 blue:0.92 alpha:1];
         chatTimeLabel.backgroundColor = [UIColor colorWithRed:0.9 green:0.9 blue:0.92 alpha:1];
         chatBubbleLabel.backgroundColor = [UIColor colorWithRed:0.9 green:0.9 blue:0.92 alpha:1];
         chatBubbleContentView.backgroundColor = [UIColor colorWithRed:0.9 green:0.9 blue:0.92 alpha:1];
        ...
        arrowIV.image = [arrowIV.image imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        [arrowIV setTintColor:[UIColor colorWithRed:0.9 green:0.9 blue:0.92 alpha:1]];
    }
